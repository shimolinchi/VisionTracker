...
def main():
    ...
    pos_filter_1 = LowPassFilter_(alpha=0.5)
    pos_filter_2 = LowPassFilter_(alpha=0.5)
        ...
        while True:
            ...
            if results.multi_hand_landmarks:
                ...
                try:
                    ...
                    pos_drive = pos_filter_1.filter(pos_cal)
